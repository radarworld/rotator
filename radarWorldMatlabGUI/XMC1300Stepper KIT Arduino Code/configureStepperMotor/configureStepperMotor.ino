...
IFX9201_STEPPERMOTOR_config_t microstep_config =
{
  .SteppingpMode = IFX9201_STEPPERMOTOR_STEPPINGMODE_MICROSTEP,
  .FreqPWMOut = 3000u,
  .PWMDutyCycleNormFactor = 5000u,
  .NumMicrosteps = 64,
  .Store = IFX9201_STEPPERMOTOR_STEPPINGMODE_STORE_CONFIG
};
...
void loop() {
	...
	MyStepperMotor.configure(CONFIG_SERIAL, &microstep_config);
